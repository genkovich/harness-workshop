...
**Ця гілка:** `step-12-guard` — результат етапу 12.
...
Очікуємо 20 тестів без мережі. Повний npm test запускай на готовому рішенні. Живий API: npm start після налаштування ключа.
