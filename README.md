...
**Ця гілка:** `step-11-skills` — результат етапу 11.
...
Очікуємо 18 тестів без мережі. Повний npm test запускай на готовому рішенні. Живий API: npm start після налаштування ключа.

**Наступна тема:** [12. Дозвіл](runbooks/12-guard.md).
