...
**Ця гілка:** `step-07-history` — результат етапу 07.
...
Очікуємо 9 тестів без мережі. Повний npm test запускай на готовому рішенні. Живий API: npm start після налаштування ключа.

**Наступна тема:** [08. Цикл і зупинка](runbooks/08-loop.md).
