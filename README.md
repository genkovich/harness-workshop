...
Модель повернула текст. Тулів у запиті ще немає. Вона не може перевірити списання: відповідь про клієнта тут ще не є перевіркою даних.

`npm test`: один запит і текстова відповідь. `TRACE=1 npm start`: у запиті немає tools.
