...
**Ця гілка:** `step-08-loop` — результат етапу 08.
...
Очікуємо 15 тестів без мережі. Повний npm test запускай на готовому рішенні. Живий API: npm start після налаштування ключа.

**Наступна тема:** [09. Експеримент з описом](runbooks/09-description.md).
