...
| [06. Виконання](06-execute.md) | step-05-call | step-06-execute | 12 |
| [07. Результат в історії](07-history.md) | step-06-execute | step-07-history | 13 |
| [08. Цикл і зупинка](08-loop.md) | step-07-history | step-08-loop | 19 |
| [09. Експеримент з описом](09-description.md) | step-08-loop | step-09-description | 20 |
| [10. Правила з файла](10-context.md) | step-09-description | step-10-context | 21 |
| [11. Skills](11-skills.md) | step-10-context | step-11-skills | 22 |
| [12. Дозвіл](12-guard.md) | step-11-skills | step-12-guard | 24 |
...
Тести мають номер теми в назві. Команда в ранбуку перевіряє цей і попередні етапи. На main та step-12-guard запускай npm test: 24 тести. Перевіряємо структуру запитів, схеми аргументів, виконання, відповідність id, історію, ліміт, помилки, контекст, skills та дозвіл. HTTP у тестах підмінено; live-виклик перевіряється окремо командою npm start із явно переданою задачею.
