...
Описи вже лежать у billing, але generateText ще їх не отримує. Сам факт наявності обʼєкта в програмі не робить його видимим моделі. Додаємо tools у запит.
...
- Після зміни видно точні аргументи, які обрала модель. Дані клієнта ще не прочитані.
