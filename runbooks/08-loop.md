...
[Усі теми](README.md) · [Попередня](07-history.md) · [Наступна](09-retry.md)
...
Якщо отримав 429 від Groq, збережи цей код і переходь до [окремого кроку 09](09-retry.md). Там додамо обмежені повтори тимчасово невдалого запиту; тут спочатку перевіряємо сам цикл без мережі.
...
Власний коміт залишився у попередній гілці. Якщо work-09 вже існує, обери нове імʼя, наприклад work-09-retry. .env і node_modules залишаються на місці. Відкрий [ранбук 09](09-retry.md) в тому самому редакторі: усі ранбуки й тести доступні в кожній гілці.
