...
Якщо отримав 429 від Groq, збережи цей код і переходь до [окремого кроку 08б](08b-limits.md). Там зменшимо дані та додамо паузу; тут спочатку перевіряємо сам цикл без мережі.
